...
function useButtonBase(parameters) {
  ...
  const hasNativeKeyboardActivation = React2.useCallback(() => {
    const root = rootRef.current;
    if (root == null) {
      return nativeButton;
    }
  ...
  const buttonProps = React2.useMemo(() => {
  ...
  const getButtonProps = React2.useCallback((externalProps = EMPTY) => {
    const {
...
true ? ButtonBase.propTypes = {
   ...
   */
  nativeButton: import_prop_types4.default.bool,
  /**
   * @ignore
   */
...
//# sourceMappingURL=chunk-QWIEP6M7.js.map
