...
true ? Grid.propTypes = {
   ...
   * @default 'row'
   */
  direction: import_prop_types16.default.oneOfType([import_prop_types16.default.oneOf(["row-reverse", "row"]), import_prop_types16.default.arrayOf(import_prop_types16.default.oneOf(["row-reverse", "row"])), import_prop_types16.default.object]),
  /**
...
function useButtonBase(parameters) {
  ...
  const hasNativeKeyboardActivation = React30.useCallback(() => {
    const root = rootRef.current;
    if (root == null) {
      return nativeButton;
    }
  ...
  const buttonProps = React30.useMemo(() => {
  ...
  const getButtonProps = React30.useCallback((externalProps = EMPTY) => {
    const {
...
var TouchRipple = React41.forwardRef(function TouchRipple2(inProps, ref) {
  ...
  const container2 = React41.useRef(null);
...
true ? ButtonBase.propTypes = {
   ...
   * @ignore
   */
  formAction: import_prop_types30.default.oneOfType([import_prop_types30.default.func, import_prop_types30.default.string]),
  /**
   * @ignore
   */
   ...
   */
  nativeButton: import_prop_types30.default.bool,
  /**
   * @ignore
   */
...
@mui/system/index.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-ZHJRVTVO.js.map
