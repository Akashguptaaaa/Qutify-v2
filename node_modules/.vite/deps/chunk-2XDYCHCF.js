...
var createEmotionCache = (options2, CustomSheet) => {
  const cache = createCache(options2);
...
function getCache(injectFirst, enableCssLayer) {
  if (injectFirst || enableCssLayer) {
    class MyStyleSheet extends StyleSheet {
      insert(rule, options2) {
        if (TEST_INTERNALS_DO_NOT_USE.insert) {
          return TEST_INTERNALS_DO_NOT_USE.insert(rule, options2);
        }
        if (this.key && this.key.endsWith("global")) {
          this.before = insertionPoint;
        }
        return super.insert(rule, options2);
      }
    }
...
function styled2(tag, options2) {
  const stylesFactory = styled(tag, options2);
  if (true) {
    return (...styles) => {
...
// node_modules/@mui/system/merge/merge.mjs
var options = {
  clone: false
};
...
var breakpoints_default = setupBreakpoints;
...
// node_modules/@mui/system/styleFunctionSx/extendSxProp.mjs
...
function unstable_createUseMediaQuery(params = {}) {
  ...
  return function useMediaQuery2(queryInput, options2 = {}) {
...
function InitColorSchemeScript(options2) {
  const {
    defaultMode = "system",
...
function useCurrentColorScheme(options2) {
  const {
    defaultMode = "light",
...
function createCssVarsProvider(options2) {
  const {
    themeId,
    /**
...
// node_modules/@mui/system/cssVars/createCssVarsTheme.mjs
...
@mui/system/index.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-2XDYCHCF.js.map
