...
var Tabs = React4.forwardRef(function Tabs2(inProps, ref) {
  ...
  const [isFocusWithinList, setIsFocusWithinList] = React4.useState(false);
  ...
  const validChildren = React4.Children.toArray(childrenProp).filter(React4.isValidElement).map((child, index) => {
