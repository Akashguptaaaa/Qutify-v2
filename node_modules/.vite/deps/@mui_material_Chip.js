...
// node_modules/@mui/material/Chip/Chip.mjs
...
var SvgIcon = React26.forwardRef(function SvgIcon2(inProps, ref) {
  ...
  const hasSvgAsChild = React26.isValidElement(children2) && children2.type === "svg";
  const ownerState = {
    ...props,
    color: color2,
    component,
...
// node_modules/@mui/material/internal/svg-icons/Cancel.mjs
...
function useForkRef(...refs) {
  const cleanupRef = React28.useRef(void 0);
  const refEffect = React28.useCallback((instance) => {
...
// node_modules/@mui/utils/unsupportedProp/unsupportedProp.mjs
...
// node_modules/@mui/material/utils/unsupportedProp.mjs
...
function useButtonBase(parameters) {
  ...
  const hasNativeKeyboardActivation = React32.useCallback(() => {
    const root = rootRef.current;
    if (root == null) {
      return nativeButton;
    }
  ...
  const buttonProps = React32.useMemo(() => {
  ...
  const getButtonProps = React32.useCallback((externalProps = EMPTY) => {
    const {
    ...
    const handleKeyDown = (event) => {
      ...
      onBeforeKeyDown == null ? void 0 : onBeforeKeyDown(event);
    ...
    const handleKeyUp = (event) => {
      ...
      onBeforeKeyUp == null ? void 0 : onBeforeKeyUp(event);
...
var LazyRipple = class _LazyRipple {
  ...
  static use() {
    ...
    const [shouldMount, setShouldMount] = React34.useState(false);
    ripple.shouldMount = shouldMount;
    ripple.setShouldMount = setShouldMount;
    React34.useEffect(ripple.mountEffect, [shouldMount]);
    return ripple;
  }
  mount() {
    if (!this.mounted) {
...
function Ripple(props) {
  ...
  const [leaving, setLeaving] = React42.useState(false);
...
`;
var TouchRipple = React43.forwardRef(function TouchRipple2(inProps, ref) {
  const props = useDefaultProps2({
    props: inProps,
    name: "MuiTouchRipple"
  });
  ...
  const [ripples, setRipples] = React43.useState([]);
  const nextKey = React43.useRef(0);
  const rippleCallback = React43.useRef(null);
  React43.useEffect(() => {
  ...
  const ignoringMouseDown = React43.useRef(false);
  const startTimer = useTimeout();
  const startTimerCommit = React43.useRef(null);
  const container2 = React43.useRef(null);
  const startCommit = React43.useCallback((params) => {
    const {
      pulsate: pulsate2,
      rippleX,
      rippleY,
  ...
  const start = React43.useCallback((event = {}, options = {}, cb = () => {
  }) => {
    const {
  ...
  const pulsate = React43.useCallback(() => {
    start({}, {
      pulsate: true
    });
  }, [start]);
  const stop = React43.useCallback((event, cb) => {
    startTimer.clear();
  ...
  return (0, import_jsx_runtime22.jsx)(TouchRippleRoot, {
...
var ButtonBase = React44.forwardRef(function ButtonBase2(inProps, ref) {
  const props = useDefaultProps2({
    props: inProps,
    name: "MuiButtonBase"
  });
  ...
  const handleBeforeKeyDown = useEventCallback_default2((event) => {
  ...
  const handleBeforeKeyUp = useEventCallback_default2((event) => {
  ...
  return (0, import_jsx_runtime23.jsxs)(ButtonBaseRoot, {
    as: ComponentProp,
    className: clsx_default(classes.root, className),
    ownerState,
    onBlur: handleBlur,
    ...
    ...other,
    children: [children2, enableTouchRipple ? (0, import_jsx_runtime23.jsx)(TouchRipple_default, {
      ref: handleRippleRef,
      center: centerRipple,
      ...TouchRippleProps
    }) : null]
...
true ? ButtonBase.propTypes = {
   ...
   * @ignore
   */
  formAction: import_prop_types31.default.oneOfType([import_prop_types31.default.func, import_prop_types31.default.string]),
  /**
   * @ignore
   */
   ...
   */
  nativeButton: import_prop_types31.default.bool,
  /**
   * @ignore
   */
...
// node_modules/@mui/material/Chip/chipClasses.mjs
function getChipUtilityClass(slot) {
  return generateUtilityClass("MuiChip", slot);
}
var chipClasses = generateUtilityClasses("MuiChip", ["root", "sizeSmall", "sizeMedium", "colorDefault", "colorError", "colorInfo", "colorPrimary", "colorSecondary", "colorSuccess", "colorWarning", "disabled", "clickable", "deletable", "outlined", "filled", "avatar", "icon", "label", "deleteIcon", "focusVisible"]);
...
var useUtilityClasses4 = (ownerState) => {
  ...
  const slots = {
    root: ["root", variant, disabled && "disabled", `size${capitalize_default(size)}`, `color${capitalize_default(color2)}`, clickable && "clickable", onDelete && "deletable"],
    label: ["label"],
    avatar: ["avatar"],
    icon: ["icon"],
...
var ChipRoot = styled_default2("div", {
  name: "MuiChip",
  slot: "Root",
  shouldForwardProp: (prop) => rootShouldForwardProp_default(prop) && prop !== "focusableWhenDisabled" && prop !== "skipFocusWhenDisabled",
  overridesResolver: (props, styles) => {
    const {
      ownerState
    } = props;
    ...
    }, styles.root, styles[`size${capitalize_default(size)}`], styles[`color${capitalize_default(color2)}`], clickable && styles.clickable, onDelete && styles.deletable, styles[variant]];
  }
})(memoTheme_default(({
  theme
}) => {
...
var Chip = React45.forwardRef(function Chip2(inProps, ref) {
  ...
  const ownerState = {
    ...
    size,
    color: color2,
    iconColor: React45.isValidElement(iconProp) ? iconProp.props.color || color2 : color2,
    onDelete: !!onDelete,
    clickable,
    variant
  };
  ...
  return (0, import_jsx_runtime24.jsxs)(RootSlot, {
    as: component,
    ...rootProps,
    children: [avatar || icon, (0, import_jsx_runtime24.jsx)(LabelSlot, {
      ...labelProps,
      children: label
    }), deleteIcon]
  });
...
true ? Chip.propTypes = {
   ...
   */
  nativeButton: import_prop_types32.default.bool,
  /**
   * @ignore
   */
